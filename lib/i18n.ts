...
const es = {
  ...
  nav: { panel: "Panel", faces: "Caras", methodology: "Metodología" },
  footer: {
...
const en: Dict = {
  ...
  nav: { panel: "Dashboard", faces: "Faces", methodology: "Methodology" },
  footer: {
...
const ca: Dict = {
  ...
  nav: { panel: "Tauler", faces: "Cares", methodology: "Metodologia" },
  footer: {
