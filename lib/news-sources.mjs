...
/**
 * Guard thresholds, defined here rather than in lib/news.ts so the app and
 * scripts/check-feeds.mjs cannot drift apart: a feed that passes the health
 * check must be a feed the live code will actually read.
 */

/** A source whose newest item is older than this is treated as dead. */
